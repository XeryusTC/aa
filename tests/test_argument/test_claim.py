...
class ClaimTest(unittest.TestCase):
    ...
    def test_can_attack(self):
        c1 = Claim(self._fw, Agent("Bart Verheij", "Arguing Agents", 29), 1, "11:00 - 13:00")
        c2 = Claim(self._fw, Agent("Rineke Verbrugge", "Multi Agent Systems", 48), 1, "11:00 - 13:00")
        c3 = Claim(self._fw, Agent("Arnold Meijster", "Imperatief Programmeren", 59), 2, "11:00 - 13:00")
        c4 = Claim(self._fw, Agent("Arnold Meijster", "Imperatief Programmeren", 59), 1, "13:00 - 15:00")
    ...
    def test_get_room(self):
        c = Claim(self._fw, Agent("Bart", "Arguing Agents", 29), 1, "11:00 - 13:00")
